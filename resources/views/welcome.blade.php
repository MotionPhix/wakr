<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-center gap-5 pt-8 sm:justify-start sm:pt-0 items-center">
            ...
            <Link 
                ...
                class="bg-lime-500 rounded px-4 text-white py-1.5 hover:bg-lime-700 transition">
                Posts
            </Link>
        </div>
